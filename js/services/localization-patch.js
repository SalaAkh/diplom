...
(function () {
    ...
    const extraPatches = {
        kk: {
            appLoadErrorDescription: "Бетті жаңартып көріңіз. Егер мәселе сақталса, барлық файлдардың дұрыс жүктелгенін тексеріңіз.",
            appLoadErrorMissing: "Қажетті компоненттерді жүктеу мүмкін болмады: {components}",
            appLoadErrorTitle: "Қосымшаны жүктеу қатесі",
            appDataErrorDescription: "Сценарий деректерін жүктеу мүмкін болмады. scenarios-data.js файлының жүктелгенін тексеріңіз.",
            appDataErrorTitle: "Деректерді жүктеу қатесі",
            appModulesErrorDescription: "Маңызды модульдерді жүктеу мүмкін болмады: {components}",
            appModulesErrorTitle: "Модульдерді жүктеу қатесі",
            advancedTestDataMissing: "Тереңдетілген тест деректері табылмады. advanced-scenarios-data.js файлының жүктелгенін тексеріңіз.",
            advancedTestInvalidQuestions: "Тереңдетілген тест деректерінің құрылымы жарамсыз: questions массиві жоқ.",
            advancedTestMissingDimensions: "Тереңдетілген тест деректерінде өлшем анықтамалары жоқ.",
            accountCreated: "Аккаунт жасалды",
            checkConsoleDetails: "Толық мәлімет үшін браузер консолін тексеріңіз.",
            chooseFile: "Файлды таңдау",
            converterDescription: "Тест нәтижелері бар JSON файлын жүктеп, оны басқа форматтарға түрлендіріңіз.",
            converterTitle: "Есеп конвертері",
            downloadAs: "Қай форматта жүктеу:",
            fileReadError: "Файлды оқу қатесі",
            fileReadSuccess: "Файл сәтті оқылды. Түрлендіру форматын таңдаңыз.",
            initializationError: "Инициализация қатесі",
            invalidReportFormat: "Есеп файлының форматы жарамсыз",
            orDragHere: "немесе осында сүйреп әкеліңіз",
            qualityAcceptable: "Қабылдауға болады",
            qualityExcellent: "Өте жақсы",
            qualityGood: "Жақсы",
            qualityPoor: "Төмен",
            qualityQuestionable: "Күмәнді",
            scenarioDataInvalid: "Сценарий деректерінің құрылымы жарамсыз. scenarios-data.js немесе scenarios.json файлының пішімін тексеріңіз.",
            scenarioDataMissing: "Сценарий деректері қолжетімсіз. scenarios-data.js файлының дұрыс жүктелгенін тексеріңіз.",
            selectedFile: "Таңдалды",
            selectJsonFile: ".json файлын таңдаңыз",
            socialComparisonHint: "Басқа пайдаланушылармен салыстыруды көру үшін тестті қайта өтіңіз.",
            testSelectionViewError: "Тест таңдау беті жүктелмеді. Бетті жаңартып көріңіз.",
            validityGood: "Жақсы",
            validityPoor: "Төмен",
            validityQuestionable: "Күмәнді"
        },
        ru: {
            appLoadErrorDescription: "Пожалуйста, обновите страницу. Если проблема сохраняется, убедитесь, что все файлы загружены корректно.",
            appLoadErrorMissing: "Не удалось загрузить необходимые компоненты: {components}",
            appLoadErrorTitle: "Ошибка загрузки приложения",
            appDataErrorDescription: "Не удалось загрузить данные сценариев. Убедитесь, что файл scenarios-data.js загружен.",
            appDataErrorTitle: "Ошибка загрузки данных",
            appModulesErrorDescription: "Не удалось загрузить критические модули: {components}",
            appModulesErrorTitle: "Ошибка загрузки модулей",
            advancedTestDataMissing: "Данные углубленного теста не найдены. Убедитесь, что файл advanced-scenarios-data.js загружен.",
            advancedTestInvalidQuestions: "Некорректная структура данных углубленного теста: отсутствует массив questions.",
            advancedTestMissingDimensions: "В данных углубленного теста отсутствуют описания измерений.",
            accountCreated: "Аккаунт создан",
            checkConsoleDetails: "Проверьте консоль браузера для подробностей.",
            chooseFile: "Выберите файл",
            converterDescription: "Загрузите JSON-файл с результатами теста, чтобы конвертировать его в другие форматы.",
            converterTitle: "Конвертер отчетов",
            downloadAs: "Скачать как:",
            fileReadError: "Ошибка чтения файла",
            fileReadSuccess: "Файл успешно прочитан. Выберите формат для конвертации.",
            initializationError: "Ошибка инициализации",
            invalidReportFormat: "Некорректный формат файла отчета",
            orDragHere: "или перетащите сюда",
            qualityAcceptable: "Приемлемое",
            qualityExcellent: "Отличное",
            qualityGood: "Хорошее",
            qualityPoor: "Плохое",
            qualityQuestionable: "Сомнительное",
            scenarioDataInvalid: "Структура данных сценариев невалидна. Проверьте формат данных в scenarios-data.js или scenarios.json.",
            scenarioDataMissing: "Данные сценариев недоступны. Убедитесь, что scenarios-data.js загружен корректно.",
            selectedFile: "Выбран",
            selectJsonFile: "Выберите .json файл",
            socialComparisonHint: "Пройдите тест еще раз, чтобы увидеть сравнение с другими пользователями.",
            testSelectionViewError: "Страница выбора теста не загрузилась. Пожалуйста, обновите страницу.",
            validityGood: "Хорошая",
            validityPoor: "Плохая",
            validityQuestionable: "Сомнительная"
        },
        en: {
            appLoadErrorDescription: "Please refresh the page. If the problem persists, make sure all files loaded correctly.",
            appLoadErrorMissing: "Failed to load the required components: {components}",
            appLoadErrorTitle: "Application load error",
            appDataErrorDescription: "Failed to load scenario data. Make sure scenarios-data.js is loaded.",
            appDataErrorTitle: "Error loading data",
            appModulesErrorDescription: "Failed to load critical modules: {components}",
            appModulesErrorTitle: "Error loading modules",
            advancedTestDataMissing: "Advanced test data was not found. Make sure advanced-scenarios-data.js is loaded.",
            advancedTestInvalidQuestions: "Invalid advanced test data structure: questions array is missing.",
            advancedTestMissingDimensions: "Advanced test data is missing dimension definitions.",
            accountCreated: "Account created",
            checkConsoleDetails: "Check browser console for details.",
            chooseFile: "Choose file",
            converterDescription: "Upload a JSON file with test results to convert it into other formats.",
            converterTitle: "Report converter",
            downloadAs: "Download as:",
            fileReadError: "Error reading file",
            fileReadSuccess: "File loaded successfully. Choose a format for conversion.",
            initializationError: "Initialization error",
            invalidReportFormat: "Invalid report file format",
            orDragHere: "or drag it here",
            qualityAcceptable: "Acceptable",
            qualityExcellent: "Excellent",
            qualityGood: "Good",
            qualityPoor: "Poor",
            qualityQuestionable: "Questionable",
            scenarioDataInvalid: "Scenario data structure is invalid. Check scenarios-data.js or scenarios.json.",
            scenarioDataMissing: "Scenario data is unavailable. Make sure scenarios-data.js is loaded correctly.",
            selectedFile: "Selected",
            selectJsonFile: "Select a .json file",
            socialComparisonHint: "Take the test again to compare yourself with other users.",
            testSelectionViewError: "The test selection screen failed to load. Please refresh the page.",
            validityGood: "Good",
            validityPoor: "Poor",
            validityQuestionable: "Questionable"
        }
    };

    Object.entries(extraPatches).forEach(([lang, values]) => {
        if (!patches[lang]) {
            patches[lang] = {};
        }
        Object.assign(patches[lang], values);
    });
